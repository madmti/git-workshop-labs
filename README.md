...
| 10 | [Reset: los tres arboles y los tres modos](https://create.kahoot.it/details/68b9d65f-f440-453a-a63d-f35dbefd3ab8) | 8 | Los tres arboles de Git (directorio de trabajo, indice y HEAD), que arbol actualiza cada modo de reset (--soft, --mixed y --hard), el modo por defecto y por que --hard es peligroso |
